...
mkValidator pkh dat () ctx = traceIfFalse "invalid signature" signedByBeneficiary &&
                             traceIfFalse "deadline passed"   validDeadline
   ...
   where
       ...
       validDeadline :: Bool
       validDeadline = contains (to dat) $ txInfoValidRange info
